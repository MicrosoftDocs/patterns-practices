...
For a list of the new features, assets, and API changes, see [What's New in Prism 5.0](/patterns-practices/guide/whats-new-in-prism-library-5.0-for-wpf(v=pandp.40)).
...
-   [Getting Started Using the Prism Library Hands-on Lab](/patterns-practices/guide/18-publishing-and-updating-applications-using-the-prism-library-5.0-for-wpf-hands-on-lab(v=pandp.40))
