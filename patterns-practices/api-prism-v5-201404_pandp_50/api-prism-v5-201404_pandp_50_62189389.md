...
Name
Description
![](https://msdn.microsoft.com/en-us/Gg419162.protproperty(en-us,PandP.50).gif "Protected property")
Subscriptions
(Inherited from EventBase.)
![](https://msdn.microsoft.com/en-us/Gg419162.pubproperty(en-us,PandP.50).gif "Public property")
