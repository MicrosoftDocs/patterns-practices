...
Name
Description
![](https://msdn.microsoft.com/en-us/Gg431032.protmethod(en-us,PandP.50).gif "Protected method")
...
(Inherited from [SelectorRegionAdapter](https://msdn.microsoft.com/t:microsoft.practices.prism.regions.selectorregionadapter).)
![](https://msdn.microsoft.com/en-us/Gg431032.protmethod(en-us,PandP.50).gif "Protected method")
...
(Inherited from [SelectorRegionAdapter](https://msdn.microsoft.com/t:microsoft.practices.prism.regions.selectorregionadapter).)
![](https://msdn.microsoft.com/en-us/Gg431032.pubmethod(en-us,PandP.50).gif "Public method")
