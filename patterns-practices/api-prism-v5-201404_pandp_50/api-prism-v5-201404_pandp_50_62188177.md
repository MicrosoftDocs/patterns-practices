...
(Inherited from [Object](http://msdn2.microsoft.com/en-us/library/e5kfa45b).)
![](https://msdn.microsoft.com/en-us/Dn683926.protmethod(en-us,PandP.50).gif "Protected method")
[GetCandidatesFromRegion](https://msdn.microsoft.com/m:microsoft.practices.prism.unityextensions.regions.unityregionnavigationcontentloader.getcandidatesfromregion(microsoft.practices.prism.regions.iregion%2csystem.string))
