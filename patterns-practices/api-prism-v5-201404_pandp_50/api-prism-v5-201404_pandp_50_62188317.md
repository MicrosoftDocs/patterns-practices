...
Specifies that the current module has a dependency on another module. This attribute should be used on classes that implement [IModule](https://msdn.microsoft.com/t:microsoft.practices.prism.modularity.imodule).
...
<span id="syntaxToggle"></span>public sealed class ModuleDependencyAttribute : AttributePublic NotInheritable Class ModuleDependencyAttribute Inherits Attribute
