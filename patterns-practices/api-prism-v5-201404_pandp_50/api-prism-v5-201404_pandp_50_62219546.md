...
Name
Description
![](https://msdn.microsoft.com/en-us/Gg430853.pubmethod(en-us,PandP.50).gif "Public method")
[ModulesConfigurationSection](https://msdn.microsoft.com/m:microsoft.practices.prism.modularity.modulesconfigurationsection.)
...
Name
Description
![](https://msdn.microsoft.com/en-us/Gg430853.protmethod(en-us,PandP.50).gif "Protected method")
...
![](https://msdn.microsoft.com/en-us/Gg430853.protmethod(en-us,PandP.50).gif "Protected method")
[DeserializeSection](http://msdn2.microsoft.com/en-us/library/ms224434)
Reads XML from the configuration file.

(Inherited from [ConfigurationSection](http://msdn2.microsoft.com/en-us/library/x0kca287).)
![](https://msdn.microsoft.com/en-us/Gg430853.pubmethod(en-us,PandP.50).gif "Public method")
...
(Inherited from [ConfigurationElement](http://msdn2.microsoft.com/en-us/library/kyx77cz3).)
![](https://msdn.microsoft.com/en-us/Gg430853.protmethod(en-us,PandP.50).gif "Protected method")
[GetRuntimeObject](http://msdn2.microsoft.com/en-us/library/fh19sky9)
...
(Inherited from [ConfigurationElement](http://msdn2.microsoft.com/en-us/library/kyx77cz3).)
![](https://msdn.microsoft.com/en-us/Gg430853.protmethod(en-us,PandP.50).gif "Protected method")
[IsModified](http://msdn2.microsoft.com/en-us/library/kkza18sx)
...
(Inherited from [ConfigurationElement](http://msdn2.microsoft.com/en-us/library/kyx77cz3).)
![](https://msdn.microsoft.com/en-us/Gg430853.protmethod(en-us,PandP.50).gif "Protected method")
[ResetModified](http://msdn2.microsoft.com/en-us/library/43904a29)
...
(Inherited from [ConfigurationElement](http://msdn2.microsoft.com/en-us/library/kyx77cz3).)
![](https://msdn.microsoft.com/en-us/Gg430853.protmethod(en-us,PandP.50).gif "Protected method")
[SerializeSection](http://msdn2.microsoft.com/en-us/library/ms224439)
Creates an XML string containing an unmerged view of the [ConfigurationSection](http://msdn2.microsoft.com/en-us/library/x0kca287) object as a single section to write to a file.
...
(Inherited from [ConfigurationElement](http://msdn2.microsoft.com/en-us/library/kyx77cz3).)
![](https://msdn.microsoft.com/en-us/Gg430853.protmethod(en-us,PandP.50).gif "Protected method")
[ShouldSerializeElementInTargetVersion](http://msdn2.microsoft.com/en-us/library/dd642104)
...
(Inherited from [ConfigurationSection](http://msdn2.microsoft.com/en-us/library/x0kca287).)
![](https://msdn.microsoft.com/en-us/Gg430853.protmethod(en-us,PandP.50).gif "Protected method")
[ShouldSerializePropertyInTargetVersion](http://msdn2.microsoft.com/en-us/library/ee169415)
...
(Inherited from [ConfigurationSection](http://msdn2.microsoft.com/en-us/library/x0kca287).)
![](https://msdn.microsoft.com/en-us/Gg430853.protmethod(en-us,PandP.50).gif "Protected method")
[ShouldSerializeSectionInTargetVersion](http://msdn2.microsoft.com/en-us/library/dd642108)
Indicates whether the current [ConfigurationSection](http://msdn2.microsoft.com/en-us/library/x0kca287) instance should be serialized when the configuration object hierarchy is serialized for the specified target version of the .NET Framework.
...
Name
Description
![](https://msdn.microsoft.com/en-us/Gg430853.pubproperty(en-us,PandP.50).gif "Public property")
...
(Inherited from [ConfigurationElement](http://msdn2.microsoft.com/en-us/library/kyx77cz3).)
![](https://msdn.microsoft.com/en-us/Gg430853.protproperty(en-us,PandP.50).gif "Protected property")
...
(Inherited from [ConfigurationElement](http://msdn2.microsoft.com/en-us/library/kyx77cz3).)
![](https://msdn.microsoft.com/en-us/Gg430853.pubproperty(en-us,PandP.50).gif "Public property")
[Modules](https://msdn.microsoft.com/p:microsoft.practices.prism.modularity.modulesconfigurationsection.modules)
...
(Inherited from [ConfigurationElement](http://msdn2.microsoft.com/en-us/library/kyx77cz3).)
![](https://msdn.microsoft.com/en-us/Gg430853.pubproperty(en-us,PandP.50).gif "Public property")
[SectionInformation](http://msdn2.microsoft.com/en-us/library/ms134300)
Gets a [SectionInformation](http://msdn2.microsoft.com/en-us/library/ms134738) object that contains the non-customizable information and functionality of the [ConfigurationSection](http://msdn2.microsoft.com/en-us/library/x0kca287) object.
