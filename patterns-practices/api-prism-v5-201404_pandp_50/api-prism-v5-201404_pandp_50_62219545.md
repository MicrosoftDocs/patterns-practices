...
Name
Description
![](https://msdn.microsoft.com/en-us/Gg430784.pubmethod(en-us,PandP.50).gif "Public method")
[InteractionRequestTrigger](https://msdn.microsoft.com/m:microsoft.practices.prism.interactivity.interactionrequest.interactionrequesttrigger.)
...
(Inherited from [Animatable](http://msdn2.microsoft.com/en-us/library/ms618388).)
![](https://msdn.microsoft.com/en-us/Gg430784.protmethod(en-us,PandP.50).gif "Protected method")
...
Name
Description
![](https://msdn.microsoft.com/en-us/Gg430784.pubproperty(en-us,PandP.50).gif "Public property")
Actions
(Inherited from TriggerBase.)
![](https://msdn.microsoft.com/en-us/Gg430784.protproperty(en-us,PandP.50).gif "Protected property")
AssociatedObject
(Inherited from TriggerBase.)
![](https://msdn.microsoft.com/en-us/Gg430784.protproperty(en-us,PandP.50).gif "Protected property")
...
Name
Description
![](https://msdn.microsoft.com/en-us/Gg430784.pubevent(en-us,PandP.50).gif "Public event")
