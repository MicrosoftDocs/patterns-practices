...
Name
Description
![](https://msdn.microsoft.com/en-us/Gg431022.protmethod(en-us,PandP.50).gif "Protected method")
...
(Inherited from [ContentControlRegionAdapter](https://msdn.microsoft.com/t:microsoft.practices.prism.regions.contentcontrolregionadapter).)
![](https://msdn.microsoft.com/en-us/Gg431022.protmethod(en-us,PandP.50).gif "Protected method")
...
(Inherited from [ContentControlRegionAdapter](https://msdn.microsoft.com/t:microsoft.practices.prism.regions.contentcontrolregionadapter).)
![](https://msdn.microsoft.com/en-us/Gg431022.pubmethod(en-us,PandP.50).gif "Public method")
