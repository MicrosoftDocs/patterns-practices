...
For a detailed overview of Prisms region support and information about how to leverage regions to compose the application's UI using view injection and discovery, see [Composing the User Interface](https://msdn.microsoft.com/9ace102b-6423-4642-ac67-80cf768c7913). The rest of this topic describes how regions have been extended to support view-based navigation, and how this addresses the various challenges described earlier.
...
[Next Topic](https://msdn.microsoft.com/1c89ff18-4df9-456f-b3fa-cd848d4e7e33) | [Previous Topic](https://msdn.microsoft.com/9ace102b-6423-4642-ac67-80cf768c7913) | [Home](http://msdn.microsoft.com/en-us/library/gg406140) | [Community](https://compositewpf.codeplex.com/)
