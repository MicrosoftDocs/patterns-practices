...
<span id="sec3"></span>Implementation Notes
===========================================
...
| <img src="https://msdn.microsoft.com/en-us/Ff921174.note(en-us,PandP.40).gif" class="note" />Note:                                                                                                                                                                                                                                                                  |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
<span id="sec4"></span>Composing the User Interface
---------------------------------------------------
...
<span id="sec5"></span>Applying View Discovery and View Injection
-----------------------------------------------------------------
...
-   From a **RegionManager** instance, because this is an extension method of that class for easy access.
    ...
    <thead>
    <tr class="header">
    <th><img src="https://msdn.microsoft.com/en-us/Ff921174.note(en-us,PandP.40).gif" class="note" />Note:</th>
    </tr>
    </thead>
    <tbody>
    <tr class="odd">
...
For more information about UI composition, see [Composing the User Interface](https://msdn.microsoft.com/9ace102b-6423-4642-ac67-80cf768c7913).
...
[Next Topic](https://msdn.microsoft.com/19294d52-40b2-481b-8e03-23efdc467fe3) | [Previous Topic](https://msdn.microsoft.com/f19ad6f5-a247-4633-aede-782856195336) | [Home](http://msdn.microsoft.com/en-us/library/gg406140) | [Community](https://compositewpf.codeplex.com/)
