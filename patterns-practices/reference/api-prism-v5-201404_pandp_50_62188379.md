...
<span id="syntaxToggle"></span>void RegisterViewWithRegion( string regionName, Type viewType )Sub RegisterViewWithRegion ( regionName As String, viewType As Type )
#### Parameters
