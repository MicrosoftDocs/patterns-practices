...
ms:mtpsurl: 'https://msdn.microsoft.com/en-us/library/Gg405925(v=PandP.50)'
---
...
<span id="remarksToggle"></span>Calls [Dispose(Boolean)](https://msdn.microsoft.com/library/microsoft.practices.prism.modularity.modulemanager.dispose(system.boolean))
