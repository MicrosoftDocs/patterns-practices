...
Type: [IRegionCollection](https://msdn.microsoft.com/t:microsoft.practices.prism.regions.iregioncollection)
A [IRegionCollection](https://msdn.microsoft.com/t:microsoft.practices.prism.regions.iregioncollection) with all the registered regions.
#### Implements

[IRegionManager..::.Regions](https://msdn.microsoft.com/p:microsoft.practices.prism.regions.iregionmanager.regions)
