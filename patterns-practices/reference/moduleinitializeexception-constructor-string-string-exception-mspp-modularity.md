...
ms:mtpsurl: 'https://msdn.microsoft.com/en-us/library/Gg405651(v=PandP.50)'
---
...
<span id="syntaxToggle"></span>public ModuleInitializeException( string moduleName, string message, Exception innerException )Public Sub New ( moduleName As String, message As String, innerException As Exception )
