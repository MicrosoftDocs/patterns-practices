...
Name
Description
![](https://msdn.microsoft.com/en-us/Gg431122.protmethod(en-us,PandP.50).gif "Protected method")
...
![](https://msdn.microsoft.com/en-us/Gg431122.pubmethod(en-us,PandP.50).gif "Public method")
...
(Inherited from [Object](http://msdn2.microsoft.com/en-us/library/e5kfa45b).)
![](https://msdn.microsoft.com/en-us/Gg431122.protmethod(en-us,PandP.50).gif "Protected method")
[GetCandidatesFromRegion](https://msdn.microsoft.com/m:microsoft.practices.prism.regions.regionnavigationcontentloader.getcandidatesfromregion(microsoft.practices.prism.regions.iregion%2csystem.string))
