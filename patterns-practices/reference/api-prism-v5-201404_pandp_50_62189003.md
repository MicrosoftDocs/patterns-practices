...
Name
Description
![](https://msdn.microsoft.com/en-us/Gg431228.pubproperty(en-us,PandP.50).gif "Public property")
Container
(Inherited from UnityContainerExtension.)
![](https://msdn.microsoft.com/en-us/Gg431228.protproperty(en-us,PandP.50).gif "Protected property")
Context
(Inherited from UnityContainerExtension.)
