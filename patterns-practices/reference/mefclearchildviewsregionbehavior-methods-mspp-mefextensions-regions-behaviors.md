...
Name
Description
![](https://msdn.microsoft.com/en-us/Dn683967.pubmethod(en-us,PandP.50).gif "Public method")
...
![](https://msdn.microsoft.com/en-us/Dn683967.protmethod(en-us,PandP.50).gif "Protected method")
...
(Inherited from [ClearChildViewsRegionBehavior](https://msdn.microsoft.com/en-us/library/microsoft.practices.prism.regions.behaviors.clearchildviewsregionbehavior(v=pandp.50)).)
![](https://msdn.microsoft.com/en-us/Dn683967.pubmethod(en-us,PandP.50).gif "Public method")
