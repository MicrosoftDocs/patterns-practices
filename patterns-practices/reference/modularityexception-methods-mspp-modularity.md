...
<td><div class="summary">
When overridden in a derived class, returns the <a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" data-raw-source="[Exception](http://msdn2.microsoft.com/en-us/library/c18k6c59)">Exception</a> that is the root cause of one or more subsequent exceptions.
</div>
...
(Overrides <a href="http://msdn.microsoft.com/en-us/library/fwb1489e" data-raw-source="[Exception.GetObjectData(SerializationInfo, StreamingContext)](http://msdn.microsoft.com/en-us/library/fwb1489e)">Exception.GetObjectData(SerializationInfo, StreamingContext)</a>.)</td>
</tr>
<tr class="even">
<td><img src="/patterns-practices/reference/images/public-method.gif" alt="Public method"/></td>
