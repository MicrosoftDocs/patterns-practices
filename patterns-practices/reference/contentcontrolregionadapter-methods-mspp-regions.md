...
(Overrides <a href="/patterns-practices/reference/iregion-interface-mspp-regions" data-raw-source="[RegionAdapterBase(Of T).Adapt(IRegion, T)](/patterns-practices/reference/iregion-interface-mspp-regions)">RegionAdapterBase(Of T).Adapt(IRegion, T)</a>.)</td>
</tr>
<tr class="even">
<td><img src="/patterns-practices/reference/images/protmethod.gif" alt="Protected method"/></td>
