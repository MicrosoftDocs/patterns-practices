...
ms:mtpsurl: 'https://msdn.microsoft.com/en-us/library/microsoft.practices.prism.regions.behaviors.regioncreationexception_properties(v=pandp.50)'
---
...
<tbody>
<tr class="odd">
<td><img src="https://msdn.microsoft.com/en-us/Gg431189.pubproperty(en-us,PandP.50).gif" title="Public property" /></td>
