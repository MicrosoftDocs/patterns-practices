...
Name
Description
![](https://msdn.microsoft.com/en-us/Gg430788.pubmethod(en-us,PandP.50).gif "Public method")
[EmptyLogger](https://msdn.microsoft.com/m:microsoft.practices.prism.logging.emptylogger.)
...
![](https://msdn.microsoft.com/en-us/Gg430788.protmethod(en-us,PandP.50).gif "Protected method")
...
(Inherited from [Object](http://msdn2.microsoft.com/en-us/library/e5kfa45b).)
![](https://msdn.microsoft.com/en-us/Gg430788.pubmethod(en-us,PandP.50).gif "Public method")
[Log](https://msdn.microsoft.com/m:microsoft.practices.prism.logging.emptylogger.log(system.string%2cmicrosoft.practices.prism.logging.category%2cmicrosoft.practices.prism.logging.priority))
