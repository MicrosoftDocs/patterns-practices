...
Name
Description
![](https://msdn.microsoft.com/en-us/Gg430809.pubmethod(en-us,PandP.50).gif "Public method")
[MefSyncRegionContextWithHostBehavior](https://msdn.microsoft.com/m:microsoft.practices.prism.mefextensions.regions.behaviors.mefsyncregioncontextwithhostbehavior.)
...
![](https://msdn.microsoft.com/en-us/Gg430809.protmethod(en-us,PandP.50).gif "Protected method")
...
(Inherited from [Object](http://msdn2.microsoft.com/en-us/library/e5kfa45b).)
![](https://msdn.microsoft.com/en-us/Gg430809.protmethod(en-us,PandP.50).gif "Protected method")
[OnAttach](https://msdn.microsoft.com/m:microsoft.practices.prism.regions.behaviors.syncregioncontextwithhostbehavior.onattach)
Override this method to perform the logic after the behavior has been attached.

(Inherited from [SyncRegionContextWithHostBehavior](https://msdn.microsoft.com/t:microsoft.practices.prism.regions.behaviors.syncregioncontextwithhostbehavior).)
![](https://msdn.microsoft.com/en-us/Gg430809.pubmethod(en-us,PandP.50).gif "Public method")
...
Name
Description
![](https://msdn.microsoft.com/en-us/Gg430809.pubproperty(en-us,PandP.50).gif "Public property")
[HostControl](https://msdn.microsoft.com/p:microsoft.practices.prism.regions.behaviors.syncregioncontextwithhostbehavior.hostcontrol)
