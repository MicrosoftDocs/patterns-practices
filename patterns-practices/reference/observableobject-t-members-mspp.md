...
<tr class="odd">
<td>![Protected method](/patterns-practices/reference/images/protmethod.gif)</td>
<td>[ArrangeOverride](http://msdn.microsoft.com/en-us/library/ms598098)</td>
<td><div class="summary">
When overridden in a derived class, positions child elements and determines a size for a [FrameworkElement](http://msdn.microsoft.com/en-us/library/ms602714) derived class.
</div>
(Inherited from [FrameworkElement](http://msdn.microsoft.com/en-us/library/ms602714).)</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td>![Protected method](/patterns-practices/reference/images/protmethod.gif)</td>
<td>[MeasureOverride](http://msdn.microsoft.com/en-us/library/ms598227)</td>
<td><div class="summary">
When overridden in a derived class, measures the size in layout required for child elements and determines a size for the [FrameworkElement](http://msdn.microsoft.com/en-us/library/ms602714)-derived class.
</div>
(Inherited from [FrameworkElement](http://msdn.microsoft.com/en-us/library/ms602714).)</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td>![Protected method](/patterns-practices/reference/images/protmethod.gif)</td>
<td>[OnCreateAutomationPeer](http://msdn.microsoft.com/en-us/library/ms598925)</td>
<td><div class="summary">
Returns class-specific [AutomationPeer](http://msdn.microsoft.com/en-us/library/ms523415) implementations for the Windows Presentation Foundation (WPF) infrastructure.
</div>
(Inherited from [UIElement](http://msdn.microsoft.com/en-us/library/ms590078).)</td>
</tr>
<tr class="even">
...
<tr class="even">
<td>![Protected method](/patterns-practices/reference/images/protmethod.gif)</td>
<td>[OnManipulationBoundaryFeedback](http://msdn.microsoft.com/en-us/library/dd549563)</td>
<td><div class="summary">
...
<tr class="odd">
<td>![Protected method](/patterns-practices/reference/images/protmethod.gif)</td>
<td>[OnVisualParentChanged](http://msdn.microsoft.com/en-us/library/ms598258)</td>
<td><div class="summary">
Invoked when the parent of this element in the visual tree is changed. Overrides [OnVisualParentChanged(DependencyObject)](http://msdn.microsoft.com/en-us/library/ms599318).
</div>
(Inherited from [FrameworkElement](http://msdn.microsoft.com/en-us/library/ms602714).)</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td>![Public event](/patterns-practices/reference/images/pubevent.gif)</td>
<td>[PropertyChanged](/patterns-practices/reference/observableobject-t-propertychanged-event-mspp)</td>
<td><div class="summary">
