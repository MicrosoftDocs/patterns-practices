...
On this page
-   [What Is a Bootstrapper?](#sec1)
-   [Dependency Injection](#sec2)
-   [Creating the Shell](#sec3)
-   [Key Decisions](#sec4)
-   [Core Scenarios](#sec5)
-   [Creating a Bootstrapper for Your Application](#sec6)
-   *[Implementing the CreateShell Method](#sec7)*
-   *[Implementing the InitializeShell Method](#sec8)*
-   [Creating and Configuring the Module Catalog](#sec9)
-   [Creating and Configuring the Container](#sec10)
-   *[Core Services](#sec11)*
-   *[Application-Specific Services](#sec12)*
-   *[Creating and Configuring the Container in the UnityBootstrapper](#sec13)*
-   *[Creating and Configuring the Container in the MefBootstrapper](#sec14)*
...
<span id="WhatIsaBootstrapper"></span>
<span id="sec1"></span>What Is a Bootstrapper?
==============================================
...
<span id="DependencyInjection"></span>
<span id="sec2"></span>Dependency Injection
-------------------------------------------
...
<span id="CreatingtheShell"></span>
<span id="sec3"></span>Creating the Shell
-----------------------------------------
...
<span id="sec4"></span>Key Decisions
====================================
...
<span id="sec5"></span>Core Scenarios
=====================================
...
<span id="CreatingaBootstrapperforYourApplica"></span>
<span id="sec6"></span>Creating a Bootstrapper for Your Application
-------------------------------------------------------------------
...
<span id="ImplementingtheCreateShellMethod"></span>
### <span id="sec7"></span>Implementing the CreateShell Method
...
| <img src="https://msdn.microsoft.com/en-us/Gg430868.note(en-us,PandP.40).gif" class="note" />Note:                                                                                                                                                                                                                                                         |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
<span id="ImplementingtheInitializeShellMethod"></span>
### <span id="sec8"></span>Implementing the InitializeShell Method
...
<span id="CreatingandConfiguringtheModuleCata"></span>
<span id="sec9"></span>Creating and Configuring the Module Catalog
------------------------------------------------------------------
...
In both the **UnityBootstrapper** and **MefBootstrapper** classes, the **Run** method calls the **CreateModuleCatalog** method and then sets the class's **ModuleCatalog** property using the returned value. If you override this method, it is not necessary to call the base class's implementation because you will replace the provided functionality. For more information about modularity, see "[Modular Application Development](https://msdn.microsoft.com/8c55fb84-b40a-4321-be92-66f9206eef92)."

<span id="CreatingandConfiguringtheContainer"></span>
<span id="sec10"></span>Creating and Configuring the Container
--------------------------------------------------------------
...
<span id="CoreServices"></span>
### <span id="sec11"></span>Core Services
...
<span id="ApplicationSpecificServices"></span>
### <span id="sec12"></span>Application-Specific Services
...
<span id="CreatingandConfiguringtheContainerUnityB"></span>
### <span id="sec13"></span>Creating and Configuring the Container in the UnityBootstrapper
...
<span id="CreatingandConfiguringtheContainerinMEF"></span>
### <span id="sec14"></span>Creating and Configuring the Container in the MefBootstrapper
...
[Next Topic](https://msdn.microsoft.com/bd745855-12db-4fb1-8f56-2e04f1ac3b63) | [Previous Topic](https://msdn.microsoft.com/badb51b5-fed3-44e2-8e0b-f307516d62ed) | [Home](http://msdn.microsoft.com/en-us/library/gg406140) | [Community](https://compositewpf.codeplex.com/)
