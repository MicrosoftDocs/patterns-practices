...
On this page
-   [Goal and Benefits](#sec1)
-   [Out of Scope](#sec2)
-   [Multi-Targeting Scenarios](#sec3)
-   [Multi-Targeted Considerations](#sec4)
-   [Multi-Targeted Elements](#sec5)
-   [A Solution to Multi-Targeting: Multiple Linked Projects](#sec6)
-   [Core Application](#sec7)
-   [Creating Multi-Targeted Applications](#sec8)
-   [Design and Code Guidelines](#sec9)
-   *[Use Separated Presentation Patterns to Maximize the Amount of Shared Code](#sec10)*
-   *[Write Code So It Compiles on Both Platforms](#sec11)*
-   *[Use \#if Statements If You Have Simple or Single Line Constructs](#sec12)*
-   *[Use Partial Classes When Most of the Class Is Similar but Some Methods Have Platform-Specific Implementations](#sec13)*
-   *[Use Partial Methods Only if You Need to Call an Extra Method on One Platform but Not the Other](#sec14)*
-   *[Build Platform-Specific Classes with a Single Responsibility](#sec15)*
-   *[Create a Solution Folder for Silverlight and Another for WPF](#sec16)*
-   *[Check Silverlight and WPF References When Refactoring Code](#sec17)*
-   [Process Guidelines](#sec18)
-   *[Develop the Core Application in Silverlight](#sec19)*
-   *[Link the Shared Code Between the Source Project and the Target Project](#sec20)*
-   *[Use the Same Namespace for Silverlight and WPF Projects](#sec21)*
-   [Team Build Guidelines](#sec22)
-   *[Configure Team Build to Build in Place](#sec23)*
-   [Contrasting Silverlight and WPF](#sec24)
-   [Silverlight and WPF Architectural Overview](#sec25)
-   [Differences Between Silverlight and WPF](#sec26)
-   *[Resources](#sec27)*
-   *[Triggers](#sec28)*
-   *[Data Binding](#sec29)*
-   *[Commanding](#sec30)*
-   *[Miscellaneous](#sec31)*
-   [More Information](#sec32)
...
<span id="GoalandBenefits"></span>
<span id="sec1"></span>Goal and Benefits
========================================
...
<span id="OutofScope"></span>
<span id="sec2"></span>Out of Scope
===================================
...
<span id="MultiTargetingScenarios"></span>
<span id="sec3"></span>Multi-Targeting Scenarios
================================================
...
<span id="MultiTargetedConsiderations"></span>
<span id="sec4"></span>Multi-Targeted Considerations
====================================================
...
<span id="MultiTargetedElements"></span>
<span id="sec5"></span>Multi-Targeted Elements
==============================================
...
<span id="ASolutiontoMultiTargetingMultiple"></span>
<span id="sec6"></span>A Solution to Multi-Targeting: Multiple Linked Projects
==============================================================================
...
<span id="CoreApplication"></span>
<span id="sec7"></span>Core Application
---------------------------------------
...
| <img src="https://msdn.microsoft.com/en-us/Ff921109.note(en-us,PandP.40).gif" class="note" />Note:                                                                                                                                                                                                  |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
<span id="CreatingMultiTargetedApplications"></span>
<span id="sec8"></span>Creating Multi-Targeted Applications
===========================================================
...
<span id="DesignAndCode"></span><span id="DesignandCodeGuidelines"></span>
<span id="sec9"></span>Design and Code Guidelines
-------------------------------------------------
...
### <span id="sec10"></span>Use Separated Presentation Patterns to Maximize the Amount of Shared Code
...
### <span id="sec11"></span>Write Code So It Compiles on Both Platforms
...
#### <span id="sec12"></span>Use \#if Statements If You Have Simple or Single Line Constructs
...
#### <span id="sec13"></span>Use Partial Classes When Most of the Class Is Similar but Some Methods Have Platform-Specific Implementations
...
#### <span id="sec14"></span>Use Partial Methods Only if You Need to Call an Extra Method on One Platform but Not the Other
...
#### <span id="sec15"></span>Build Platform-Specific Classes with a Single Responsibility
...
### <span id="sec16"></span>Create a Solution Folder for Silverlight and Another for WPF
...
### <span id="sec17"></span>Check Silverlight and WPF References When Refactoring Code
...
<span id="Process"></span><span id="ProcessGuidelines"></span>
<span id="sec18"></span>Process Guidelines
------------------------------------------
...
### <span id="sec19"></span>Develop the Core Application in Silverlight
...
### <span id="sec20"></span>Link the Shared Code Between the Source Project and the Target Project
...
### <span id="sec21"></span>Use the Same Namespace for Silverlight and WPF Projects

Keep the namespaces the same between projects because the shared code requires the same namespace.

<span id="TeamBuild"></span><span id="TeamBuildGuidelines"></span>
<span id="sec22"></span>Team Build Guidelines
---------------------------------------------

This section describes Team Build guidelines.

### <span id="sec23"></span>Configure Team Build to Build in Place
...
<span id="ContrastingSilverlightandWPF"></span>
<span id="sec24"></span>Contrasting Silverlight and WPF
=======================================================
...
<span id="SilverlightandWPFArchitecturalOvervi"></span>
<span id="sec25"></span>Silverlight and WPF Architectural Overview
------------------------------------------------------------------
...
<span id="DifferencesBetweenSilverlightandWPF"></span><span id="_Toc208212613"></span>
<span id="sec26"></span>Differences Between Silverlight and WPF
---------------------------------------------------------------
...
<span id="_Toc208212614"></span>
### <span id="sec27"></span>Resources
...
<span id="_Toc208212616"></span>
### <span id="sec28"></span>Triggers
...
<span id="_Toc208212617"></span>
### <span id="sec29"></span>Data Binding
...
<span id="_Toc208212618"></span>
### <span id="sec30"></span>Commanding
...
<span id="_Toc208212619"></span>
### <span id="sec31"></span>Miscellaneous
...
<span id="sec32"></span>More Information
========================================
...
[Next Topic](https://msdn.microsoft.com/f3832e66-c6ce-46cc-a77f-e70df7f96638) | [Previous Topic](https://msdn.microsoft.com/98cfdf83-ee9f-41e2-a1b7-86f23a47c103) | [Home](http://msdn.microsoft.com/en-us/library/gg406140) | [Community](https://compositewpf.codeplex.com/)
