...
On this page
-   [Summary](#sec1)
-   [Intended Audience](#sec2)
-   [Architectural Goals](#sec3)
-   [System Requirements](#sec4)
-   [Resources](#sec5)
-   [Guidance Assets](#sec6)
-   [Feedback and Support](#sec7)
-   [Future Plans](#sec8)
-   [Related Titles](#sec9)
-   [Prism Team Blogs](#sec10)
-   [Authors and Contributors](#sec11)

[patterns & practices Developer Center](http://www.microsoft.com/practices)

2012

<span id="sec1"></span>Summary
==============================
...
<span id="sec2"></span>Intended Audience
========================================
...
<span id="sec3"></span>Architectural Goals
==========================================
...
<span id="sec4"></span>System Requirements
==========================================
...
| <img src="https://msdn.microsoft.com/en-us/Gg430869.note(en-us,PandP.40).gif" class="note" />Note:                                                                                                                                                                                                                                                                           |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
<p><a href="https://msdn.microsoft.com/98cfdf83-ee9f-41e2-a1b7-86f23a47c103">Prism NuGet Packages</a></p>
...
<td><p><a href="https://msdn.microsoft.com/98cfdf83-ee9f-41e2-a1b7-86f23a47c103">Prism 4.1 ReadMe</a> (includes installation instructions).</p>
...
<tr class="odd">
<td><p>Book</p></td>
<td><p><a href="http://shop.oreilly.com/product/0790145315496.do"><img src="https://msdn.microsoft.com/en-us/Gg430869.Prism4Cover(en-us,PandP.40).png" /></a></p>
<p><a href="http://shop.oreilly.com/product/0790145315496.do">Buy book</a></p></td>
</tr>
<tr class="even">
<td><p>Upgrading</p></td>
<td><p><a href="https://msdn.microsoft.com/ed11a7d3-2244-479a-b72e-01a9eda86b3b">Updgrading from Prism 2.x</a></p>
...
<p><a href="https://msdn.microsoft.com/1c19fd0f-ac78-45d8-be6e-5ba39040dedd">Publishing and Updating Applications Using the Prism Library Hands-on Lab</a></p>
...
<span id="sec6"></span>Guidance Assets
======================================
...
<span id="sec7"></span>Feedback and Support
===========================================
...
<span id="sec8"></span>Future Plans
===================================
...
<span id="sec9"></span>Related Titles
=====================================
...
<span id="sec10"></span>Prism Team Blogs
========================================
...
<span id="sec11"></span>Authors and Contributors
================================================
...
[Previous Topic](https://msdn.microsoft.com/59d7af06-a074-4959-9ce8-094b894d1d46) | [Home](http://msdn.microsoft.com/en-us/library/gg406140) | [Community](https://compositewpf.codeplex.com/)
